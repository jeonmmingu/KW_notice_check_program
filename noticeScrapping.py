...
def kwCrawling(pageNum, filename):
    ...
    for i in range(1, pageNum + 1):
        ...
        url = "https://www.kw.ac.kr/ko/life/notice.jsp?MaxRows=10&tpage="+str(i)+"&searchKey=1&searchVal=&srCategoryId="
...
def ceCrawling(pageNum, filename):
    ...
    for i in range(1, pageNum+1):
        # Request url information from the Server
        url = "https://ce.kw.ac.kr:501/department_office/lecture.php?page=" + str(i) + "&site_type=2&make=&search=&make=&search="
...
def csCrawling(pageNum, filename):
    ...
    for i in range(1, pageNum + 1):
        # Request url information from the Server
        url = "https://cs.kw.ac.kr:501/department_office/lecture.php?page=" + str(i) + "&site_type=3&make=&search=&make=&search="
...
def icCrawling(pageNum, filename):
    ...
    for i in range(1, pageNum + 1):
        # Request url information from the Server
        url = "https://ic.kw.ac.kr:501/department_office/lecture.php?page=" + str(i) + "&site_type=4&make=&search=&make=&search="
